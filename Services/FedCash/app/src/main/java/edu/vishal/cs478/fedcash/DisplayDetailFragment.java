...
public class DisplayDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup vg, Bundle savedInstanceState){
        return inflater.inflate(R.layout.fragment_display_detail, vg,false);
    ...
    public void showQuoteAtIndex(int newIndex) {
        if (newIndex < 0 || newIndex >= mQuoteArrayLen)
            return;
        mCurrIdx = newIndex;
        mQuoteView.setText(DisplayActivity.right.get(mCurrIdx));
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mQuoteArrayLen = DisplayActivity.right.size();
    }
